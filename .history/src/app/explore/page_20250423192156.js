...
export default async function ExplorePage(props) {
  // Get searchParams the correct way for server components
  const searchParams = props.searchParams;

  // Fetch deals based on search parameters - do this first before accessing searchParams
  const deals = await fetchFeaturedDeals();

  // Now safely create our params object after the async operation
