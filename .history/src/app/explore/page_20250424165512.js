...
export default async function ExplorePage(props) {
  // Fetch deals first before accessing searchParams
  const deals = await fetchFeaturedDeals();

  // Instead of directly accessing searchParams, pass it as a prop to client components
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="flex justify-between items-center mb-6">
            ...
            {/* Use a client component for the select or a simpler approach */}
