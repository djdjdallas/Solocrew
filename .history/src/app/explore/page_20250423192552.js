...
export default async function ExplorePage(props) {
  ...
  // Instead of accessing searchParams directly, pass the entire object to the client component
  // Let the client component handle the extraction of parameters
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="flex justify-between items-center mb-6">
            ...
            <Select defaultValue={rawSearchParams.sort || "recommended"}>
