...
export default function DealDetailPage() {
  ...
  function processData(deal) {
    ...
    try {
      // Safely handle tier_discounts which might be a string or an object
      const tierDiscountsRaw = deal.tier_discounts || "{}";
      const tierDiscounts =
        typeof tierDiscountsRaw === "string"
          ? JSON.parse(tierDiscountsRaw)
          : tierDiscountsRaw;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <DealGallery
            ...
            galleryUrls={
              deal.gallery_urls
                ? typeof deal.gallery_urls === "string"
                  ? JSON.parse(deal.gallery_urls)
                  : deal.gallery_urls
                : []
            }
          />
